...
\usepackage{graphicx} % 必须添加此行才能显示图片
...
\begin{document}
    ...
    \section{教育}
        \begin{twocolentry}{
            ...
            \textbf{金陵科技学院},土木工程\end{twocolentry}
    ...
    \section{项目}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item 负责60MW分布式光伏EPC总承包项目的全流程技术统筹与外部协调，跟进项目确户、房屋荷载安全检测及相关行政审批工作
    ...
    \section{技能}
        \begin{onecolentry}
            \textbf{Computer Languages:}  C, Nix, Lua,LaTex
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Technologies:} Neovim,Nixpkgs, CAD, Rhino,Linux,熟练使用ai
        \end{onecolentry}
